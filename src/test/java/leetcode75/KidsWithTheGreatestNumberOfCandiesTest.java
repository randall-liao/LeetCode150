...
class KidsWithTheGreatestNumberOfCandiesTest {
    ...
    private final KidsWithTheGreatestNumberOfCandies defaultTestClass = new KidsWithTheGreatestNumberOfCandies();
    ...
    void kidWithCandies_emptyArrayInput_expectedIllegalArgumentException() {
        int[] intArray = {};
        assertThrows(IllegalArgumentException.class, () -> defaultTestClass.kidWithCandies(intArray, 0));
    }

    @Test
    void kidWithCandies_negativeExtraCandiesInput_expectedIllegalArgumentException() {
        int[] intArray = {0, 0, 0};
        assertThrows(IllegalArgumentException.class, () -> defaultTestClass.kidWithCandies(intArray, -20));
    }

    @Test
    void kidWithCandies_mixedInputArrayExampleOne_expectedBothTrueAndFalse() {
        List<Boolean> expectedResultList = new ArrayList<>(Arrays.asList(true, true, true, false, true));
    ...
    void kidWithCandies_mixedInputArrayExampleTwo_expectedBothTrueAndFalse() {
        List<Boolean> expectedResultList = new ArrayList<>(Arrays.asList(true, false, false, false, false));
